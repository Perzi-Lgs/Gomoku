...
def check_diagonal(table, type):
    ...
    for y in range(0, 16):
        for x in range(0, 16):
            if (table[y][x] == target and table[y][x + 1] == target and table[y][x + 2] == target and table[y][x + 3] == target):
                change_value(table, x + 4, y, type * 200)
            if (table[y][x] == target and table[y + 1][x] == target and table[y + 2][x] == target and table[y + 3][x] == target):
                change_value(table, x, y + 4, type * 200)
